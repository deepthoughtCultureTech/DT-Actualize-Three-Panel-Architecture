              ...
              {filtered.length === 0 ? (
                ...
                filtered.map((p) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <span
                        className={`inline-flex items-center gap-1 rounded-full px-2 py-1 text-xs ${statusChip(
                          p.status
                        )}`}
                      >
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center justify-center gap-2">
                        <Link
                          ...
                          className="inline-flex items-center cursor-pointer gap-2 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs font-medium text-slate-700 hover:bg-slate-50"
                          title="Manage"
                        >
                        ...
                        <button
                          ...
                          className="inline-flex cursor-pointer items-center gap-2 rounded-lg bg-rose-600 px-3 py-1.5 text-xs font-medium text-white hover:bg-rose-700"
                          title="Delete"
                        >
                          <Trash size={16} />
                          Delete
